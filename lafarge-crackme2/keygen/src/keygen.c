...
void GenSerial(HWND hWnd)
{
	...
	unsigned char bArray1[4] = { 0xAA, 0x89, 0xC4, 0xFE };
	unsigned char bArray2[4] = { 0x78, 0xF0, 0xD0, 0x03 };
	unsigned char bArray3[4] = { 0xF7, 0xFD, 0xF4, 0xE7 };
	unsigned char bArray4[4] = { 0xB5, 0x1B, 0xC9, 0x50 };
